...
$connect = @mysqli_connect($dbhost,$dbuser,$dbpass,$dbname);
		...
		$result = mysqli_query($connect,"INSERT INTO info2 (ten_tai_xe,xuat_phat,dich_den,thoi_gian,dien_thoai,tin_nhan) VALUES ('$ten_tai_xe','$xuat_phat','$dich_den','$thoi_gian','$dien_thoai','$tin_nhan')");
		}
